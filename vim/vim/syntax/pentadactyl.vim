...
syn keyword pentadactylCommand loadplugins lpl gr[oup] ! run Clistk[eys] Clk
    ...
    \ cunm[ap] delbm[arks] delc[ommand] delg[roup] deli[bar] delmac[ros]
    ...
    \ ha[rdcopy] h[elp] helpa[ll] hi[ghlight] hist[ory] hs ia[bbreviate] if
    \ ilistk[eys] ilk im[ap] ino[remap] iuna[bbreviate] iunm[ap] javas[cript] js
    \ ju[mps] keepa[lt] let listc[ommands] lc listk[eys] lk listo[ptions] lo
    \ mac[ros] map ma[rk] marks mes[sages] messc[lear] mkp[entadactylrc]
    \ mks[yntax] mlistk[eys] mlk mm[ap] mno[remap] munm[ap] nlistk[eys] nlk
    \ nm[ap] nno[remap] noh[lfind] no[remap] norm[al] nunm[ap] olistk[eys] olk
    \ om[ap] ono[remap] o[pen] ounm[ap] pa[geinfo] pagest[yle] pas pin[tab]
    \ pref[erences] prefs pw[d] py qma[rk] qmarks q[uit] quita[ll] qa[ll]
    \ redr[aw] reg[isters] reh[ash] re[load] reloada[ll] res[tart] runt[ime]
    \ sa[nitize] sav[eas] w[rite] sbcl[ose] scrip[tnames] se[t] setg[lobal]
    \ setl[ocal] sideb[ar] sb[ar] sbop[en] sil[ent] so[urce] st[op] stopa[ll]
    \ sty[le] styled[isable] styd[isable] stylee[nable] stye[nable]
    \ stylet[oggle] styt[oggle] tab taba[ttach] tabc[lose] tabde[tach] tabd[o]
    \ bufd[o] tabdu[plicate] tabl[ast] bl[ast] tabm[ove] tabn[ext] tn[ext]
    \ bn[ext] tabo[nly] tabopen t[open] tabnew tabp[revious] tp[revious]
    \ tabN[ext] tN[ext] bp[revious] bN[ext] tabr[ewind] tabfir[st] br[ewind]
    \ bf[irst] thl time tlistk[eys] tlk tm[ap] tno[remap] toolbarh[ide] tbh[ide]
    \ toolbars[how] tbs[how] toolbart[oggle] tbt[oggle] tunm[ap] tweet
